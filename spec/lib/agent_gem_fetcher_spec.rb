...
RSpec.describe AgentGemFetcher, type: :model do
  it 'parses a gemspec file' do
    ...
    stub_request(:get, "https://api.github.com/search/code?q=huginn%20extension:gemspec%20path:/").
      with(headers: {'Accept' => 'application/vnd.github.v3+json', 'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'Content-Type' => 'application/json', 'User-Agent' => 'Octokit Ruby Gem 4.14.0'}).
